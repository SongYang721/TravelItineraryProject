        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApprovedByStaff = table.Column<bool>(type: "bit", nullable: true),
                    ItineraryId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "3781efa7-66dc-47f0-860f-e506d04102e4", 0, "ef25d428-fd6f-436c-8927-2f2f1e743757", "admin@localhost.com", true, "Admin", "User", false, null, "ADMIN@LOCALHOST.COM", "ADMIN@LOCALHOST.COM", "AQAAAAIAAYagAAAAEI3TNTP49fH543T1y+fur3uAlsJCX6Ne5UZGh1TZ1Qcv2/Y7N1tVejSqhPvSkHWReQ==", null, false, "6de07a36-c429-4d5c-93b5-5574cf2c28cb", false, "admin@localhost.com" });

            migrationBuilder.InsertData(
                table: "Customer",
                columns: new[] { "CustomerId", "EmailAddress", "FirstName", "LastName", "Password", "RequestID" },
                values: new object[,]
                {
                    { 1, "johndoe@example.com", "John", "Doe", "hashedPasswordUser1", "REQ001" },
                    { 2, "janesmith@example.com", "Jane", "Smith", "hashedPasswordUser2", "REQ002" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Staff",
                columns: new[] { "StaffId", "Name", "Password" },
                values: new object[,]
                {
                    { 1, "Alice Johnson", "hashedPassword123" },
                    { 2, "Bob Smith", "hashedPassword456" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Booking",
                columns: new[] { "BookingId", "BookingDate", "CustomerId", "ItineraryId", "PaymentId", "StaffId" },
                values: new object[,]
                {
                    { 1, new DateOnly(2024, 1, 3), 1, 1, 1, 1 },
                    { 2, new DateOnly(2025, 8, 2), 2, 2, 2, 2 }
                });
